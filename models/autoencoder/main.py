# Code Author: James Harcourt
# Source: https://github.com/bakerjo/autoencoder-perception/blob/main/autoencoder2.py
...
def train(dims=20):
    ...
    for e in range(800):
        print("Epoch: ", e)
        missing, masks, complete = X_MISSING[e * 512:(e + 1) * 512], MASKS[e * 512:(e + 1) * 512], X_COMPLETE[e * 512:(
                                                                                                                                  e + 1) * 512]
...
def train_alt(dims=20):
    ...
    for e in range(200):
        print("Epoch: ", e)
        missing, masks, complete = X_MISSING[e * 2048:(e + 1) * 2048], MASKS[e * 2048:(e + 1) * 2048], X_COMPLETE[
                                                                                                       e * 2048:(
                                                                                                                            e + 1) * 2048]
        x = np.nan_to_num(missing, 0)
