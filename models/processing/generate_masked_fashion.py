...
if __name__ == "__main__":
    ...
    np.savez(f"../../data/fashion_masked{walk_length_min}_{walk_length_max}_{direction_change_chance}.npz", X_train=X_train, X_test=X_test, X_train_masked=X_train_masked, X_test_masked=X_test_masked, X_masks=X_masks, X_test_masks=X_test_masks, y_train=y_train, y_test=y_test)
