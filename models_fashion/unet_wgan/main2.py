...
class UNet():
    ...
    def __init__(self):
        ...
        self.data_source = '../../data/fashion_masked100_600_0.7.npz'
    ...
    def build_discriminator(self):
        ...
        p1 = Conv2D(16, kernel_size=1, strides=1, padding="same")(image)
        p1 = LeakyReLU(alpha=0.2)(p1)

        # Parallel path 2 - Large kernel for broad features
        p2 = Conv2D(16, kernel_size=8, strides=1, padding="same")(image)
    ...
    def build_generator(self):
        ...
        # Decoder
        d3 = Conv2DTranspose(32, kernel_size=(4, 4), strides=(2, 2), padding='same')(e3)
        d3 = Concatenate()([d3, e2])  # Skip connection
        ...
        # Output layer
        d1 = Conv2DTranspose(8, kernel_size=(4, 4), strides=(1, 1), padding='same')(d2)
        d1 = BatchNormalization()(d1)
        d1 = LeakyReLU(alpha=0.2)(d1)

        output = Conv2DTranspose(1, kernel_size=(4, 4), strides=(1, 1), padding='same')(d1)
    ...
    def train(self, epochs, batch_size, sample_interval):
        ...
        for epoch in range(epochs):
            ...
            if epoch <= 400 or epoch % 8 == 0:
                ...
                metrics = self.wgan.train_step(batch_size)
