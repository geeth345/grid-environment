...
# building a self attention based refinement network
class SAGAN():
    ...
    def __init__(self):
        ...
        self.gen_fine = self.build_generator()
        ...
        self.discriminator.compile(loss=['binary_crossentropy', 'sparse_categorical_crossentropy'], optimizer=Adam(0.00015, 0.5, 0.9), metrics=['accuracy'], loss_weights=[0.6, 0.4])
        ...
        self.combined.compile(loss=['binary_crossentropy', 'sparse_categorical_crossentropy'], optimizer=Adam(0.00020, 0.5, 0.9), metrics=['accuracy'], loss_weights=[0.6, 0.4])
    ...
    def build_generator(self):
        ...
        # Attention Path
        x1 = Conv2D(8, kernel_size=4, strides=1, padding="same")(image)
        ...
        model = Model(inputs=image, outputs=output, name='generator')
...
if __name__ == '__main__':
    net = SAGAN()
    net.train(epochs=5001, batch_size=64, sample_interval=200)
