...
class UNet():
    ...
    def __init__(self):
        ...
        d_optimiser = Adam(0.0004, 0.6, 0.9)
        g_optimiser = Adam(0.0004, 0.6, 0.9)
        ...
        self.generator.compile(loss='mean_squared_error', optimizer=Adam(0.0006, 0.5))
    ...
    def train(self, epochs, batch_size, sample_interval):
        ...
        for epoch in range(epochs):
            ...
            if epoch <= 400 or (epoch <= 1000 and epoch % 8 == 0):
...
if __name__ == '__main__':
    unet = UNet()
    unet.train(epochs=2501, batch_size=64, sample_interval=100)
